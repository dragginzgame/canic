...
pub(super) fn observed_only_recommendations(
    ...
    vec![declare_role_recommendation(app, role)]
}
...
fn declare_role_recommendation(app: &str, role: &str) -> AdoptionRecommendationV1 {
    AdoptionRecommendationV1 {
        kind: "declare_role".to_string(),
        severity: AdoptionRecommendationSeverityV1::Info,
        description: format!("declare observed role candidate {app}.{role} before attachment"),
        suggested_action: Some(format!(
            "canic app role declare {app} {role} --package <path>"
        )),
...
fn review_authority_before_declaration_recommendation(
    ...
    AdoptionRecommendationV1 {
        ...
        description: format!(
            "review {app}.{role} authority before declaring observed role candidate ({})",
...
pub(super) fn attach_later_recommendation(app: &str, role: &str) -> AdoptionRecommendationV1 {
    AdoptionRecommendationV1 {
