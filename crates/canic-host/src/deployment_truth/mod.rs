...
pub use lifecycle::{
    CriticalExternalFixReportError, ExternalLifecyclePendingReportError,
    ExternalLifecyclePlanError, ExternalUpgradeConsentEvidenceError,
    ...
    critical_external_fix_report_from_pending, external_lifecycle_pending_report_from_plan,
    ...
    validate_critical_external_fix_report_for_pending, validate_external_lifecycle_pending_report,
