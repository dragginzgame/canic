...
pub use lifecycle::{
    ...
    ExternalUpgradeConsentEvidenceError, ExternalUpgradeProposalReportError,
    ExternalUpgradeReceiptError, ExternalUpgradeVerificationReportError,
    LifecycleAuthorityReportError, critical_external_fix_report_from_pending,
    ...
    external_upgrade_receipt_from_observation, external_upgrade_verification_report_from_receipt,
    lifecycle_authority_report_from_check, validate_critical_external_fix_report,
    validate_critical_external_fix_report_for_pending, validate_external_lifecycle_check,
    validate_external_lifecycle_check_for_reports, validate_external_lifecycle_handoff,
    validate_external_lifecycle_handoff_for_reports, validate_external_lifecycle_pending_report,
    validate_external_lifecycle_pending_report_for_plan, validate_external_lifecycle_plan,
    validate_external_lifecycle_plan_for_check, validate_external_upgrade_consent_evidence,
...
pub use model::{
    ...
    ExternalUpgradeAuthorizationModeV1, ExternalUpgradeConsentEvidenceRequest,
    ExternalUpgradeConsentEvidenceV1, ExternalUpgradeConsentStateV1,
    ExternalUpgradeProposalReportV1, ExternalUpgradeProposalV1, ExternalUpgradeReceiptV1,
    ExternalUpgradeVerificationReportRequest, ExternalUpgradeVerificationReportV1,
    ExternalUpgradeVerificationResultV1, LifecycleAuthorityReportV1, LifecycleAuthorityV1,
...
pub use text::{
    ...
    critical_external_fix_report_text, deployment_execution_preflight_text,
    external_lifecycle_check_text, external_lifecycle_handoff_text,
    external_lifecycle_pending_report_text, external_lifecycle_plan_text,
    external_upgrade_consent_evidence_text, external_upgrade_proposal_report_text,
    external_upgrade_receipt_text, external_upgrade_verification_report_text,
