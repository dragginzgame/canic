...
pub use model::{
    ...
    DeploymentRootVerificationStateTransitionV1, DeploymentRootVerificationStateV1, DiffItemV1,
    ExpectedCanisterV1, ExpectedPoolCanisterV1, ExternalLifecycleCheckV1,
    ExternalLifecycleHandoffActionV1, ExternalLifecycleHandoffV1, ExternalLifecyclePendingActionV1,
    ...
    LifecycleAuthorityReportV1, LifecycleAuthorityV1, LifecycleModeV1, LifecycleUpgradeModeV1,
...
pub use text::{
    ...
    deployment_execution_preflight_text, deployment_root_verification_receipt_text,
    deployment_root_verification_report_text, external_lifecycle_check_text,
