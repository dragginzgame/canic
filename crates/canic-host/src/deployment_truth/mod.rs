...
pub use model::{
    ...
    DeploymentAssumptionV1, DeploymentCommandResultV1, DeploymentDiffV1, DeploymentIdentityV1,
    ...
    RoleEpochObservationV1, SafetyFindingV1, SafetyReportV1, SafetySeverityV1, SafetyStatusV1,
...
pub use report::{compare_plan_to_inventory, safety_report_from_diff};
