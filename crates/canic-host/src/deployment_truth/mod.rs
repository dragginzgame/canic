...
pub use model::{
    ...
    DeploymentRootVerificationStateV1, DiffItemV1, ExpectedCanisterV1, ExpectedPoolCanisterV1,
...
pub use root::{
    DeploymentRootVerificationReportError, deployment_root_verification_report_from_check,
...
pub use text::{
    ...
    deployment_execution_preflight_text, deployment_root_verification_report_text,
    ...
    external_upgrade_completion_report_text, external_upgrade_consent_evidence_text,
