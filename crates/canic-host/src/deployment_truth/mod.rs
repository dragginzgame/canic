...
pub use model::{
    ...
    RolePromotionReadinessV1, RolePromotionWasmStoreIdentityV1, SafetyFindingV1, SafetyReportV1,
...
pub use text::{
    ...
    promotion_target_execution_lineage_text, promotion_wasm_store_identity_report_text,
};
