...
pub use model::{
    ...
    AuthorityAutomaticActionV1, AuthorityControlClassCountV1, AuthorityControllerObservationV1,
    AuthorityDryRunEvidenceV1, AuthorityExternalActionV1, AuthorityProfileV1, AuthorityReceiptV1,
    ...
    DeploymentCheckV1, DeploymentCommandResultV1, DeploymentDiffV1, DeploymentExecutionStatusV1,
