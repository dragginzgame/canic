...
pub(in crate::deployment_truth::tests) const RELEASE_SET_USER_HUB_CANDID_SHA256: &str =
    "1111111111111111111111111111111111111111111111111111111111111111";
pub(in crate::deployment_truth::tests) const RELEASE_SET_USER_HUB_PROFILE_DIGEST: &str =
...
pub(in crate::deployment_truth::tests) fn write_release_set_manifest(icp_root: &Path) {
    ...
    let manifest = serde_json::json!({
        ...
        "entries": [{
            ...
            "candid_sha256_hex": RELEASE_SET_USER_HUB_CANDID_SHA256,
            "protocol_profile_digest_hex": RELEASE_SET_USER_HUB_PROFILE_DIGEST,
