...
pub(super) use canisters::{
    ...
    COMPONENT_REGISTRY_ROLE_MISSING_CODE, DUPLICATE_CANISTER_OBSERVED_CODE,
    DUPLICATE_PLANNED_CANISTER_ROLE_CODE, EXTRA_CANISTER_OBSERVED_CODE,
    PLANNED_CANISTER_DUPLICATE_DIFF_CATEGORY, PLANNED_CANISTER_ID_CONFLICT_DIFF_CATEGORY,
    PLANNED_CANISTER_ROLE_CONFLICT_DIFF_CATEGORY, ROLE_MISMATCH_DIFF_CATEGORY,
