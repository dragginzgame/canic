...
pub(super) fn scenarios() -> Vec<AuditScenario> {
    vec![
        ...
        AuditScenario {
            key: "root:canic_command:respond-capability-request-cycles-fresh",
            canister: "root",
            endpoint_or_flow: "canic_command",
            transport_mode: "update",
            subject_kind: "endpoint",
            subject_label: "canic_command::RespondCapability",
        ...
        AuditScenario {
            key: "root:canic_command:respond-capability-request-cycles-replay",
            canister: "root",
            endpoint_or_flow: "canic_command",
            transport_mode: "update",
            subject_kind: "endpoint",
