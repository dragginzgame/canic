...
pub(super) fn scenarios() -> Vec<AuditScenario> {
    let mut scenarios = vec![
        ...
        AuditScenario {
            key: "root:canic_prepare_delegation_proof:fresh-shard",
            canister: "root",
            endpoint_or_flow: "canic_prepare_delegation_proof",
            transport_mode: "update",
            subject_kind: "endpoint",
            subject_label: "canic_prepare_delegation_proof",
            ...
            notes: "Root delegation provisioning request from a freshly created shard to exercise delegated auth issuance and issuer canister-signature checkpoints.",
        },
        AuditScenario {
