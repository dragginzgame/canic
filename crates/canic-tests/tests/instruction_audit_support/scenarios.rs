...
pub(super) fn scenarios() -> Vec<AuditScenario> {
    let mut scenarios = vec![
        ...
        AuditScenario {
            key: "root:canic_prepare_delegation_proof_batch:fresh-shard",
            canister: "root",
            endpoint_or_flow: "canic_prepare_delegation_proof_batch",
            transport_mode: "update",
            subject_kind: "endpoint",
            subject_label: "canic_prepare_delegation_proof_batch",
