...
pub use canic_core::protocol::{
    ...
    CANIC_FLEET_REGISTRY_ROOT_DRAINING_RESERVATION_STATUS, CANIC_FLEET_REGISTRY_SNAPSHOT_FOR_ROOT,
    ...
    CANIC_ROOT_COMPONENT_DIRECTORIES_SYNCHRONIZE, CANIC_ROOT_COMPONENT_DIRECTORY_HEAD,
    ...
    CANIC_ROOT_COMPONENT_DRAINING_INVENTORY_FINALIZE, CANIC_ROOT_COMPONENT_DRAINING_STATUS,
    CANIC_ROOT_COMPONENT_INSTALL, CANIC_ROOT_COMPONENT_MEMBERSHIP_ACTIVATE,
    CANIC_ROOT_COMPONENT_MEMBERSHIP_REMOVE, CANIC_ROOT_COMPONENT_PROVISIONING_ACCEPT,
    CANIC_ROOT_COMPONENT_PROVISIONING_ACTIVATE, CANIC_ROOT_COMPONENT_PROVISIONING_ADVANCE,
