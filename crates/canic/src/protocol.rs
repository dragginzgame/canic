...
pub use canic_core::protocol::{
    ...
    CANIC_FLEET_COMPONENT_PROVISIONING_PREPARE, CANIC_FLEET_COMPONENT_PROVISIONING_STATUS,
    CANIC_FLEET_REGISTRY, CANIC_FLEET_REGISTRY_ACKNOWLEDGE_ROOT, CANIC_FLEET_REGISTRY_ACTIVATE,
