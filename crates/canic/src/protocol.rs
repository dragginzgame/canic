...
pub use canic_core::protocol::{
    ...
    CANIC_ROOT_COMPONENT_CHILD_ALLOCATION_STATUS, CANIC_ROOT_COMPONENT_CHILD_CREATE,
    CANIC_ROOT_COMPONENT_CHILD_INSTALL, CANIC_ROOT_COMPONENT_COMMIT, CANIC_ROOT_COMPONENT_CREATE,
