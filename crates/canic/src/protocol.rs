...
pub use canic_core::protocol::{
    ...
    CANIC_FLEET_REGISTRY_VERSION, CANIC_FLEET_SUBNET_ROOT_AUTHORITY, CANIC_FLEET_SUBNET_ROOT_JOIN,
    ...
    CANIC_METADATA, CANIC_PREPARE_DELEGATED_TOKEN, CANIC_PREPARE_FLEET_ACTIVATION,
