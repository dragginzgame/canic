...
pub use canic_core::protocol::{
    ...
    CANIC_FLEET_REGISTRY_MANIFEST, CANIC_FLEET_REGISTRY_ROOT_ACKNOWLEDGEMENTS,
    ...
    CANIC_RESUME_FLEET_ACTIVATION, CANIC_ROOT_ISSUER_RENEWAL_STATUS, CANIC_ROOT_STORE_BOOTSTRAP,
