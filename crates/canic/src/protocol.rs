...
pub use canic_core::protocol::{
    ...
    CANIC_WASM_STORE_INFO, CANIC_WASM_STORE_PREPARE, CANIC_WASM_STORE_PREPARE_GC,
    CANIC_WASM_STORE_PUBLISH_CHUNK, CANIC_WASM_STORE_STATUS,
};
...
pub const CANIC_WASM_STORE_RETIREMENT_STATUS: &str = "canic_wasm_store_retirement_status";
