...
pub use canic_core::protocol::{
    ...
    BLOB_STORAGE_UPDATE_GATEWAY_PRINCIPALS, CANIC_COMMAND, CANIC_COORDINATOR_COMMAND,
    CANIC_COORDINATOR_STATUS, CANIC_ROOT_COMMAND, CANIC_ROOT_STATUS, CANIC_STATUS,
    CANIC_WASM_STORE_COMMAND, CANIC_WASM_STORE_STATUS, command_endpoint_for_role,
    status_endpoint_for_role,
};
