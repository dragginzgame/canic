...
impl AuthApi {
    ...
    const DELEGATED_TOKEN_ISSUER_DISABLED: &str = "delegated token issuer disabled for this canister; set tree_specs.<tree-spec>.canisters.<role>.auth.delegated_token_issuer=true in canic.toml";
