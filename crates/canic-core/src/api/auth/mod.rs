...
impl AuthApi {
    ...
    const DELEGATED_TOKEN_ISSUER_DISABLED: &str = "delegated token issuer disabled for this canister; enable auth.delegated_token_issuer on its Component Spec or direct-child table in canic.toml";
