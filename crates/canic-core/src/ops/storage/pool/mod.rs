//! Module: ops::storage::pool
//!
//! Responsibility: provide deterministic canister-pool storage operations.
//! Does not own: pool scheduling workflow, canister lifecycle calls, or endpoint DTOs.
//! Boundary: storage ops facade over stable pool records.
