...
pub mod compiled {
    ...
    pub use crate::{
        ...
        config::schema::{
            ...
            FleetInitMode, FleetServicePlacementPolicyConfig, FleetServiceTargetConfig,
            FleetServicesConfig, IcpRefillPolicy, IndexConfig, IndexPool, LogConfig,
            ...
            TopupPolicy, Whitelist, implicit_root_canister_config,
