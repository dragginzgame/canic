...
pub const CANIC_AUTHORITY_RESTORE_FENCE_STATUS: &str = "canic_authority_restore_fence_status";
pub const CANIC_AUTHORITY_SNAPSHOT_PREPARE: &str = "canic_authority_snapshot_prepare";
pub const CANIC_AUTHORITY_SNAPSHOT_RESUME: &str = "canic_authority_snapshot_resume";
...
pub const CANIC_FLEET_COMPONENT_PROVISIONING_ADVANCE: &str =
...
pub const CANIC_FLEET_REGISTRY_ROOT_DRAINING_RESERVATION_PREPARE: &str =
    "canic_fleet_registry_root_draining_reservation_prepare";
pub const CANIC_FLEET_REGISTRY_ROOT_DRAINING_RESERVATION_STATUS: &str =
...
pub const CANIC_FLEET_SUBNET_ROOT_DRAINING_STATUS: &str = "canic_fleet_subnet_root_draining_status";
pub const CANIC_FLEET_SUBNET_ROOT_DRAINING_INVENTORY_FINALIZE: &str =
...
pub const CANIC_ROOT_COMPONENT_DIRECTORIES_SYNCHRONIZE: &str =
...
pub const CANIC_ROOT_COMPONENT_DRAINING_INVENTORY_FINALIZE: &str =
    "canic_root_component_draining_inventory_finalize";
pub const CANIC_ROOT_COMPONENT_DELETE: &str = "canic_root_component_delete";
pub const CANIC_ROOT_COMPONENT_MEMBERSHIP_REMOVE: &str = "canic_root_component_membership_remove";
pub const CANIC_ROOT_COMPONENT_DELETION_STATUS: &str = "canic_root_component_deletion_status";
...
pub const CANIC_ROOT_COMPONENT_SUBTREE_REMOVAL_STOP_PREPARE: &str =
    "canic_root_component_subtree_removal_stop_prepare";
pub const CANIC_ROOT_COMPONENT_SUBTREE_REMOVAL_STOP: &str =
    "canic_root_component_subtree_removal_stop";
pub const CANIC_ROOT_COMPONENT_SUBTREE_REMOVAL_DELETE_PREPARE: &str =
...
pub const CANIC_ROOT_COMPONENT_SUBTREE_REMOVAL_DIRECTORY_SYNCHRONIZE: &str =
    "canic_root_component_subtree_removal_directory_synchronize";
pub const CANIC_ROOT_COMPONENT_SUBTREE_REMOVAL_LEAF_FINALIZE: &str =
...
pub const CANIC_ROOT_COMPONENT_CHILD_MEMBERSHIP_ACTIVATE: &str =
