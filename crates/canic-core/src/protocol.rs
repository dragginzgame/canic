...
pub const WASM_STORE_BOOTSTRAP_STAGE_MANIFEST_ADMIN: &str =
    "wasm_store_bootstrap_stage_manifest_admin";
pub const WASM_STORE_BOOTSTRAP_PREPARE_ADMIN: &str = "wasm_store_bootstrap_prepare_admin";
pub const WASM_STORE_BOOTSTRAP_PUBLISH_CHUNK_ADMIN: &str =
    "wasm_store_bootstrap_publish_chunk_admin";
pub const WASM_STORE_BOOTSTRAP_RESUME_ROOT_ADMIN: &str = "wasm_store_bootstrap_resume_root_admin";
