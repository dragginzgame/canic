...
use crate::{
    ...
    protocol::{
        CANIC_ACTIVATE_FLEET, CANIC_COMPONENT_RUNTIME_DIRECTORY_PREPARE,
        ...
        CANIC_FLEET_SUBNET_ROOT_AUTHORITY, CANIC_MANAGED_CANISTER_BINDING,
...
pub fn require_prepared_nonroot_endpoint(
    ...
    if is_status_query(call)
        ...
        || is_query(call, CANIC_COMPONENT_RUNTIME_DIRECTORY_STATUS)
