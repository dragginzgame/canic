...
- `0.25.3` continues the post-audit runtime trim by cutting more avoidable work out of the delegated-auth issuance path, including replay payload compaction, cheaper delegation cert hashing, and a thinner root signing/cache path for `canic_request_delegation`.
