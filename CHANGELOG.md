...
- `0.28.2` adds focused lifecycle-gap regression coverage for verifier proof-cache loss, moves the reinstall/upgrade mechanics into the test harness, and records the accepted delegated-auth lifecycle status: [docs/design/0.28-delegated-auth-lifecycle/0.28-status.md](docs/design/0.28-delegated-auth-lifecycle/0.28-status.md).
