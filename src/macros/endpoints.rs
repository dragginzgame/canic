...
macro_rules! icu_endpoints {
    () => {
        ...
        fn ic_cycles_accept(max_amount: u128) -> u128 {
            ::mimic::ic::api::msg_cycles_accept(max_amount)
        }
        ...
        fn canister_state() -> ::actor::state::core::CanisterStateData {
            ::actor::interface::state::core::canister_state::get_data()
        }

        // child_index
        #[$crate::ic::query]
        fn child_index() -> ::actor::state::core::ChildIndexData {
            ::actor::interface::state::core::child_index::get_data()
        }

        // subnet_index
        #[$crate::ic::query]
        fn subnet_index() -> ::actor::state::core::SubnetIndexData {
            ::actor::interface::state::core::subnet_index::get_data()
        }
    };
}
