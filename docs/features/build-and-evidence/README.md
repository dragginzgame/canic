...
build attached roles, record exactly what produced an artifact, inspect saved
deployment evidence, and apply passive policy without turning those reads into
...
- deployment-check evidence envelopes and manifests
- passive policy gates over previously captured evidence
- read-only adoption reports for existing or partial resources
- canonical network-scoped Fleet catalog inspection
...
or adopt discovered resources. Mutation remains in explicit install and
lifecycle workflows.
