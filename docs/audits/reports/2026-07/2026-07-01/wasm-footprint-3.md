...
- Auditor: `codex`
- Run timestamp (UTC): `2026-07-01T12:33:12Z`
- Branch: `main`
- Worktree: `dirty`
- Profile: `release`
...
| Artifact sizes recorded in machine-readable artifact | PASS | [size-report.json](artifacts/wasm-footprint-3/size-report.json) and [size-metrics.tsv](artifacts/wasm-footprint-3/size-metrics.tsv) retain aggregate and baseline data. |
...
| Baseline path selected by daily baseline discipline | PASS | Current run stem is `wasm-footprint-3`; baseline path resolves to `docs/audits/reports/2026-07/2026-07-01/wasm-footprint.md`. |
...
| --- | --- | --- | ---: | --- | --- |
| `app` | leaf-canister | `table[0]` | 2410413 | largest retained symbol from raw-built twiggy analysis | [app.md](artifacts/wasm-footprint-3/app.md) |
| `user_hub` | leaf-canister | `table[0]` | 2558736 | largest retained symbol from raw-built twiggy analysis | [user_hub.md](artifacts/wasm-footprint-3/user_hub.md) |
| `user_shard` | leaf-canister | `table[0]` | 2520675 | largest retained symbol from raw-built twiggy analysis | [user_shard.md](artifacts/wasm-footprint-3/user_shard.md) |
| `scale_hub` | leaf-canister | `table[0]` | 2431162 | largest retained symbol from raw-built twiggy analysis | [scale_hub.md](artifacts/wasm-footprint-3/scale_hub.md) |
| `scale_replica` | leaf-canister | `table[0]` | 2418916 | largest retained symbol from raw-built twiggy analysis | [scale_replica.md](artifacts/wasm-footprint-3/scale_replica.md) |
| `root` | bundle-canister | `table[0]` | 2815367 | control-plane outlier; embeds only the bootstrap wasm_store artifact and should not be compared directly to leaf peers | [root.md](artifacts/wasm-footprint-3/root.md) |
...
| `root` | 5625631 | 311114 | -32431 | control-plane bundle outlier |
...
| --- | --- | --- |
| Root control-plane outlier | WARN | `root` shrunk wasm = 5625631. |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- |
| `app` | leaf-canister | 3785387 | 3554375 | 231012 | 960457 | 864792 | -1983 | 6428 | 6428 | 18 | [app.md](artifacts/wasm-footprint-3/app.md) |
| `user_hub` | leaf-canister | 3953837 | 3712170 | 241667 | 1010821 | 912301 | -2131 | 6754 | 6754 | 22 | [user_hub.md](artifacts/wasm-footprint-3/user_hub.md) |
| `user_shard` | leaf-canister | 3906918 | 3671154 | 235764 | 999791 | 908633 | -2131 | 6657 | 6657 | 23 | [user_shard.md](artifacts/wasm-footprint-3/user_shard.md) |
| `scale_hub` | leaf-canister | 3819247 | 3586172 | 233075 | 969041 | 876211 | -2039 | 6487 | 6487 | 21 | [scale_hub.md](artifacts/wasm-footprint-3/scale_hub.md) |
| `scale_replica` | leaf-canister | 3795507 | 3563881 | 231626 | 962808 | 869774 | -2136 | 6456 | 6456 | 19 | [scale_replica.md](artifacts/wasm-footprint-3/scale_replica.md) |
| `root` | bundle-canister | 5936745 | 5625631 | 311114 | 2223028 | 2084635 | -32431 | 8513 | 8513 | 40 | [root.md](artifacts/wasm-footprint-3/root.md) |
...
| `root` | 113274283 | 5936745 | +107337538 | 1808.02% | 24784527 |
...
1. Owner boundary: `shared runtime baseline`
   ...
   Target report date/run: `docs/audits/reports/2026-07/2026-07-01/wasm-footprint-3.md`
...
- [scale_replica.md](artifacts/wasm-footprint-3/scale_replica.md)
