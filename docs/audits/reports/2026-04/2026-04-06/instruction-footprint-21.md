# Instruction Footprint Audit - 2026-04-06

## Report Preamble

- Scope: Canic instruction footprint (first `0.26` baseline, partial canister scope)
- Definition path: `docs/audits/recurring/system/instruction-footprint.md`
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-06/instruction-footprint-20.md`
- Code snapshot identifier: `9d276513`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-06T15:06:16Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- |
| Scenario manifest recorded | PASS | `artifacts/instruction-footprint-21/scenario-manifest.json` captures the scenario identity tuple for every sampled endpoint. |
| Normalized perf rows recorded | PASS | `artifacts/instruction-footprint-21/perf-rows.json` stores canonical endpoint rows with count and total local instructions. |
| Checkpoint deltas recorded | PASS | `artifacts/instruction-footprint-21/checkpoint-deltas.json` stores non-zero per-scenario checkpoint rows. |
...
| Flow checkpoint coverage scanned | PASS | `artifacts/instruction-footprint-21/flow-checkpoints.log` records the current repo scan result. |
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `audit_leaf_probe` | `audit_time_probe` | `minimal-valid` | 1 | 25375 | 25375 | N/A | same-call local-only perf probe |
| `audit_leaf_probe` | `audit_env_probe` | `minimal-valid` | 1 | 27027 | 27027 | N/A | same-call local-only perf probe |
| `audit_leaf_probe` | `audit_log_probe` | `empty-page` | 1 | 306606 | 306606 | N/A | same-call local-only perf probe |
| `audit_root_probe` | `audit_subnet_registry_probe` | `representative-valid` | 1 | 68995 | 68995 | N/A | same-call local-only perf probe |
| `audit_root_probe` | `audit_subnet_state_probe` | `minimal-valid` | 1 | 24320 | 24320 | N/A | same-call local-only perf probe |
| `audit_scaling_probe` | `audit_plan_create_worker_probe` | `empty-pool` | 1 | 55290 | 55290 | N/A | same-call local-only perf probe |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 1719933 | 1719933 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 817 | 817 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 489149 | 489149 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 415480 | 415480 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 190864 | 190864 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 338309 | 338309 | N/A |  |
...
- `crates/canic-control-plane/src/workflow/runtime/template/publication.rs:1333:canic_core::perf!("publish_prepare_store");`
- `crates/canic-control-plane/src/workflow/runtime/template/publication.rs:1362:canic_core::perf!("publish_push_store_chunk");`
- `crates/canic-control-plane/src/workflow/runtime/template/publication.rs:1400:canic_core::perf!("publish_promote_manifest");`
- `crates/canic-core/src/ops/auth/delegation.rs:27:crate::perf!("resolve_signing_key_name");`
- `crates/canic-core/src/ops/auth/delegation.rs:29:crate::perf!("hash_cert");`
- `crates/canic-core/src/ops/auth/delegation.rs:31:crate::perf!("build_root_derivation_path");`
- `crates/canic-core/src/ops/auth/delegation.rs:33:crate::perf!("sign_cert");`
- `crates/canic-core/src/ops/storage/auth/mod.rs:200:crate::perf!("cache_root_verifier_map_entry");`
- `crates/canic-core/src/storage/stable/auth/mod.rs:60:crate::perf!("cache_root_verifier_clone_state");`
- `crates/canic-core/src/storage/stable/auth/mod.rs:69:crate::perf!("cache_root_verifier_apply_upsert");`
- `crates/canic-core/src/storage/stable/auth/mod.rs:71:crate::perf!("cache_root_verifier_write_state");`
- `crates/canic-core/src/workflow/auth.rs:143:crate::perf!("encode_install_request");`
- `crates/canic-core/src/workflow/auth.rs:144:crate::perf!("issue_proof");`
- `crates/canic-core/src/workflow/auth.rs:166:crate::perf!("push_signers");`
- `crates/canic-core/src/workflow/auth.rs:179:crate::perf!("push_verifiers");`
- `crates/canic-core/src/workflow/auth.rs:248:crate::perf!("encode_install_request");`
- `crates/canic-core/src/workflow/auth.rs:296:crate::perf!("prepare_call");`
- `crates/canic-core/src/workflow/auth.rs:307:crate::perf!("execute_call");`
- `crates/canic-core/src/workflow/auth.rs:318:crate::perf!("decode_response");`
- `crates/canic-core/src/workflow/auth.rs:329:crate::perf!("finalize_result");`
...
- `crates/canic-core/src/workflow/rpc/request/handler/capability.rs:153:crate::perf!("hash_replay_delegation_cert");`
- `crates/canic-core/src/workflow/rpc/request/handler/capability.rs:156:crate::perf!("hash_replay_delegation_targets");`
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:157:crate::perf!("cache_root_verifier_keys");`
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:165:crate::perf!("cache_root_verifier_upsert");`
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:184:crate::perf!("cache_root_verifier_metrics");`
...
- `crates/canic-core/src/workflow/rpc/request/handler/replay.rs:173:crate::perf!("commit_encode");`
- `crates/canic-core/src/workflow/rpc/request/handler/replay.rs:182:crate::perf!("abort_replay");`
- `crates/canic-core/src/workflow/rpc/request/handler/replay.rs:44:crate::perf!("prepare_replay_input");`
...
| --- | --- | --- | ---: | ---: | ---: |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `sign_cert` | 1 | 336044 | 336044 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `encode_install_request` | 1 | 297175 | 297175 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 213475 | 213475 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 141945 | 141945 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::capability` | `hash_replay_delegation_cert` | 1 | 123971 | 123971 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::storage::stable::auth` | `cache_root_verifier_write_state` | 1 | 87528 | 87528 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 1 | 67404 | 67404 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `evaluate_replay` | 1 | 64289 | 64289 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `execute_call` | 1 | 63105 | 63105 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `push_verifiers` | 1 | 57762 | 57762 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 49716 | 49716 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `push_signers` | 1 | 48289 | 48289 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 1719933 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `root:canic_response_capability_v1:request-cycles-fresh` | 489149 | Root dispatcher plus replay/capability workflow | [request handler](/home/adam/projects/canic/crates/canic-core/src/workflow/rpc/request/handler/mod.rs), [replay workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/rpc/request/handler/replay.rs) |
| 3 | `root:canic_template_stage_manifest_admin:single-chunk` | 415480 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| --- | --- | --- |
| Flow checkpoint coverage present | INFO | Current repo scan found 78 `perf!` call sites under `crates/`. |
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 1719933 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-21/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 78 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 34 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-21/checkpoint-deltas.json`. |
...
2. Owner boundary: `shared update hotspots`
   Action: compare `root::canic_request_delegation`, `root::canic_response_capability_v1`, and the local `test::test` update floor before/after any shared-runtime cleanup, using this report as the `0.26` baseline.
...
- [instruction-footprint-21.md](./instruction-footprint-21.md)
- [scenario-manifest.json](artifacts/instruction-footprint-21/scenario-manifest.json)
- [perf-rows.json](artifacts/instruction-footprint-21/perf-rows.json)
- [endpoint-matrix.tsv](artifacts/instruction-footprint-21/endpoint-matrix.tsv)
- [checkpoint-deltas.json](artifacts/instruction-footprint-21/checkpoint-deltas.json)
- [flow-checkpoints.log](artifacts/instruction-footprint-21/flow-checkpoints.log)
- [checkpoint-coverage-gaps.json](artifacts/instruction-footprint-21/checkpoint-coverage-gaps.json)
- [verification-readout.md](artifacts/instruction-footprint-21/verification-readout.md)
- [method.json](artifacts/instruction-footprint-21/method.json)
- [environment.json](artifacts/instruction-footprint-21/environment.json)
