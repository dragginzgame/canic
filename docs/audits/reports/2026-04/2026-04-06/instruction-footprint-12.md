...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-06/instruction-footprint-11.md`
- Code snapshot identifier: `9fc4ec89`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-06T13:26:59Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- |
| Scenario manifest recorded | PASS | `artifacts/instruction-footprint-12/scenario-manifest.json` captures the scenario identity tuple for every sampled endpoint. |
| Normalized perf rows recorded | PASS | `artifacts/instruction-footprint-12/perf-rows.json` stores canonical endpoint rows with count and total local instructions. |
| Checkpoint deltas recorded | PASS | `artifacts/instruction-footprint-12/checkpoint-deltas.json` stores non-zero per-scenario checkpoint rows. |
...
| Flow checkpoint coverage scanned | PASS | `artifacts/instruction-footprint-12/flow-checkpoints.log` records the current repo scan result. |
...
| `audit_root_probe` | `audit_subnet_registry_probe` | `representative-valid` | 1 | 76910 | 76910 | N/A | same-call local-only perf probe |
...
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 335885 | 335885 | N/A |  |
...
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 139092 | 139092 |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-12/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 69 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 25 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-12/checkpoint-deltas.json`. |
...
- [instruction-footprint-12.md](./instruction-footprint-12.md)
- [scenario-manifest.json](artifacts/instruction-footprint-12/scenario-manifest.json)
- [perf-rows.json](artifacts/instruction-footprint-12/perf-rows.json)
- [endpoint-matrix.tsv](artifacts/instruction-footprint-12/endpoint-matrix.tsv)
- [checkpoint-deltas.json](artifacts/instruction-footprint-12/checkpoint-deltas.json)
- [flow-checkpoints.log](artifacts/instruction-footprint-12/flow-checkpoints.log)
- [checkpoint-coverage-gaps.json](artifacts/instruction-footprint-12/checkpoint-coverage-gaps.json)
- [verification-readout.md](artifacts/instruction-footprint-12/verification-readout.md)
- [method.json](artifacts/instruction-footprint-12/method.json)
- [environment.json](artifacts/instruction-footprint-12/environment.json)
