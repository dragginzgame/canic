...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-06/instruction-footprint-8.md`
- Code snapshot identifier: `9fc4ec89`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-06T13:00:46Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- |
| Scenario manifest recorded | PASS | `artifacts/instruction-footprint-9/scenario-manifest.json` captures the scenario identity tuple for every sampled endpoint. |
| Normalized perf rows recorded | PASS | `artifacts/instruction-footprint-9/perf-rows.json` stores canonical endpoint rows with count and total local instructions. |
| Checkpoint deltas recorded | PASS | `artifacts/instruction-footprint-9/checkpoint-deltas.json` stores non-zero per-scenario checkpoint rows. |
...
| Flow checkpoint coverage scanned | PASS | `artifacts/instruction-footprint-9/flow-checkpoints.log` records the current repo scan result. |
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `audit_leaf_probe` | `audit_time_probe` | `minimal-valid` | 1 | 33645 | 33645 | N/A | same-call local-only perf probe |
| `audit_leaf_probe` | `audit_env_probe` | `minimal-valid` | 1 | 35291 | 35291 | N/A | same-call local-only perf probe |
| `audit_leaf_probe` | `audit_log_probe` | `empty-page` | 1 | 314184 | 314184 | N/A | same-call local-only perf probe |
| `audit_root_probe` | `audit_subnet_registry_probe` | `representative-valid` | 1 | 76679 | 76679 | N/A | same-call local-only perf probe |
| `audit_root_probe` | `audit_subnet_state_probe` | `minimal-valid` | 1 | 31972 | 31972 | N/A | same-call local-only perf probe |
| `audit_scaling_probe` | `audit_plan_create_worker_probe` | `empty-pool` | 1 | 63828 | 63828 | N/A | same-call local-only perf probe |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 1726864 | 1726864 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 819 | 819 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 596332 | 596332 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 414189 | 414189 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 189035 | 189035 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 335704 | 335704 | N/A |  |
...
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:257:canic_core::perf!("chunk_store_insert");`
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:266:canic_core::perf!("chunk_store_accounting");`
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:277:canic_core::perf!("chunk_store_insert");`
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:284:canic_core::perf!("chunk_store_accounting");`
...
- `crates/canic-core/src/workflow/auth.rs:141:crate::perf!("encode_install_request");`
- `crates/canic-core/src/workflow/auth.rs:142:crate::perf!("issue_proof");`
- `crates/canic-core/src/workflow/auth.rs:164:crate::perf!("push_signers");`
- `crates/canic-core/src/workflow/auth.rs:177:crate::perf!("push_verifiers");`
- `crates/canic-core/src/workflow/auth.rs:240:crate::perf!("encode_install_request");`
- `crates/canic-core/src/workflow/auth.rs:288:crate::perf!("prepare_call");`
- `crates/canic-core/src/workflow/auth.rs:299:crate::perf!("execute_call");`
- `crates/canic-core/src/workflow/auth.rs:310:crate::perf!("decode_response");`
- `crates/canic-core/src/workflow/auth.rs:321:crate::perf!("finalize_result");`
...
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:163:crate::perf!("cache_root_verifier_proof");`
- `crates/canic-core/src/workflow/rpc/request/handler/mod.rs:101:crate::perf!("preflight");`
- `crates/canic-core/src/workflow/rpc/request/handler/mod.rs:120:crate::perf!("execute_capability");`
- `crates/canic-core/src/workflow/rpc/request/handler/mod.rs:132:crate::perf!("commit_replay");`
- `crates/canic-core/src/workflow/rpc/request/handler/mod.rs:95:crate::perf!("extract_context");`
- `crates/canic-core/src/workflow/rpc/request/handler/mod.rs:98:crate::perf!("map_request");`
...
| --- | --- | --- | ---: | ---: | ---: |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `sign_cert` | 1 | 340983 | 340983 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `encode_install_request` | 1 | 298425 | 298425 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 246461 | 246461 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 214599 | 214599 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 138734 | 138734 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 138569 | 138569 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 136009 | 136009 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 111129 | 111129 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 1 | 66040 | 66040 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `evaluate_replay` | 1 | 65109 | 65109 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `hash_cert` | 1 | 63906 | 63906 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `execute_call` | 1 | 62970 | 62970 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 1726864 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `root:canic_response_capability_v1:request-cycles-fresh` | 596332 | Root dispatcher plus replay/capability workflow | [request handler](/home/adam/projects/canic/crates/canic-core/src/workflow/rpc/request/handler/mod.rs), [replay workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/rpc/request/handler/replay.rs) |
| 3 | `root:canic_template_stage_manifest_admin:single-chunk` | 414189 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 1726864 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-9/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 71 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 34 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-9/checkpoint-deltas.json`. |
...
- [instruction-footprint-9.md](./instruction-footprint-9.md)
- [scenario-manifest.json](artifacts/instruction-footprint-9/scenario-manifest.json)
- [perf-rows.json](artifacts/instruction-footprint-9/perf-rows.json)
- [endpoint-matrix.tsv](artifacts/instruction-footprint-9/endpoint-matrix.tsv)
- [checkpoint-deltas.json](artifacts/instruction-footprint-9/checkpoint-deltas.json)
- [flow-checkpoints.log](artifacts/instruction-footprint-9/flow-checkpoints.log)
- [checkpoint-coverage-gaps.json](artifacts/instruction-footprint-9/checkpoint-coverage-gaps.json)
- [verification-readout.md](artifacts/instruction-footprint-9/verification-readout.md)
- [method.json](artifacts/instruction-footprint-9/method.json)
- [environment.json](artifacts/instruction-footprint-9/environment.json)
