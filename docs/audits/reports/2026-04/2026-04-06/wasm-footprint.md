...
- Code snapshot identifier: `9b3aade1`
- Method tag/version: `Method V1`
- Comparability status: `comparable`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-06T11:03:28Z`
- Branch: `main`
- Worktree: `dirty`
- Profile: `release`
...
| --- | --- | --- | ---: | --- | --- |
| `app` | leaf-canister | `table[0]` | 980734 | largest retained symbol from raw-built twiggy analysis | [app.md](artifacts/wasm-footprint/app.md) |
| `minimal` | leaf-canister | `table[0]` | 980734 | shared-runtime floor; use this to judge workspace baseline pressure | [minimal.md](artifacts/wasm-footprint/minimal.md) |
| `user_hub` | leaf-canister | `table[0]` | 1144718 | largest retained symbol from raw-built twiggy analysis | [user_hub.md](artifacts/wasm-footprint/user_hub.md) |
| `user_shard` | leaf-canister | `table[0]` | 1090963 | largest retained symbol from raw-built twiggy analysis | [user_shard.md](artifacts/wasm-footprint/user_shard.md) |
| `scale_hub` | leaf-canister | `table[0]` | 1039204 | largest retained symbol from raw-built twiggy analysis | [scale_hub.md](artifacts/wasm-footprint/scale_hub.md) |
| `scale` | leaf-canister | `table[0]` | 997772 | largest retained symbol from raw-built twiggy analysis | [scale.md](artifacts/wasm-footprint/scale.md) |
| `root` | bundle-canister | `table[0]` | 2490353 | control-plane outlier; embeds only the bootstrap wasm_store artifact and should not be compared directly to leaf peers | [root.md](artifacts/wasm-footprint/root.md) |

## Current Size Snapshot

| Canister | Shrunk wasm | Shrink delta | Baseline delta | Note |
| --- | ---: | ---: | --- | --- |
| `app` | 1635267 | 112990 | N/A | role-specific leaf |
| `minimal` | 1635266 | 112991 | N/A | shared runtime floor |
| `user_hub` | 1798394 | 124214 | N/A | role-specific leaf |
| `user_shard` | 1748808 | 122089 | N/A | role-specific leaf |
| `scale_hub` | 1695975 | 117123 | N/A | role-specific leaf |
| `scale` | 1653143 | 114093 | N/A | role-specific leaf |
| `root` | 3665447 | 232401 | N/A | control-plane bundle outlier |
...
| --- | --- | --- |
| Minimal floor close to feature canisters | WARN | `minimal` shrunk wasm = 1635266, `app` shrunk wasm = 1635267. |
| Root control-plane outlier | WARN | `root` shrunk wasm = 3665447. |
| Shrink delta unexpectedly low | OK | `minimal` shrink delta = 112991 bytes. |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- |
| `app` | leaf-canister | 1748257 | 1635267 | 112990 | 495977 | 461494 | N/A | 3331 | 3331 | 16 | [app.md](artifacts/wasm-footprint/app.md) |
| `minimal` | leaf-canister | 1748257 | 1635266 | 112991 | 495587 | 461480 | N/A | 3331 | 3331 | 16 | [minimal.md](artifacts/wasm-footprint/minimal.md) |
| `user_hub` | leaf-canister | 1922608 | 1798394 | 124214 | 556743 | 512370 | N/A | 3660 | 3660 | 20 | [user_hub.md](artifacts/wasm-footprint/user_hub.md) |
| `user_shard` | leaf-canister | 1870897 | 1748808 | 122089 | 539985 | 500566 | N/A | 3528 | 3528 | 20 | [user_shard.md](artifacts/wasm-footprint/user_shard.md) |
| `scale_hub` | leaf-canister | 1813098 | 1695975 | 117123 | 518062 | 479973 | N/A | 3445 | 3445 | 19 | [scale_hub.md](artifacts/wasm-footprint/scale_hub.md) |
| `scale` | leaf-canister | 1767236 | 1653143 | 114093 | 503783 | 469906 | N/A | 3371 | 3371 | 17 | [scale.md](artifacts/wasm-footprint/scale.md) |
| `root` | bundle-canister | 3897848 | 3665447 | 232401 | 1515986 | 1406053 | N/A | 5724 | 5724 | 41 | [root.md](artifacts/wasm-footprint/root.md) |
