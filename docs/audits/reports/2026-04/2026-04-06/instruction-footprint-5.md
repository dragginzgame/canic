...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-06/instruction-footprint-4.md`
- Code snapshot identifier: `31b137ec`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-06T12:10:02Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- |
| Scenario manifest recorded | PASS | `artifacts/instruction-footprint-5/scenario-manifest.json` captures the scenario identity tuple for every sampled endpoint. |
| Normalized perf rows recorded | PASS | `artifacts/instruction-footprint-5/perf-rows.json` stores canonical endpoint rows with count and total local instructions. |
| Checkpoint deltas recorded | PASS | `artifacts/instruction-footprint-5/checkpoint-deltas.json` stores non-zero per-scenario checkpoint rows. |
...
| Flow checkpoint coverage scanned | PASS | `artifacts/instruction-footprint-5/flow-checkpoints.log` records the current repo scan result. |
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `audit_leaf_probe` | `audit_time_probe` | `minimal-valid` | 1 | 33503 | 33503 | N/A | same-call local-only perf probe |
| `audit_leaf_probe` | `audit_env_probe` | `minimal-valid` | 1 | 35155 | 35155 | N/A | same-call local-only perf probe |
| `audit_leaf_probe` | `audit_log_probe` | `empty-page` | 1 | 316076 | 316076 | N/A | same-call local-only perf probe |
| `audit_root_probe` | `audit_subnet_registry_probe` | `representative-valid` | 1 | 76286 | 76286 | N/A | same-call local-only perf probe |
| `audit_root_probe` | `audit_subnet_state_probe` | `minimal-valid` | 1 | 31872 | 31872 | N/A | same-call local-only perf probe |
| `audit_scaling_probe` | `audit_plan_create_worker_probe` | `empty-pool` | 1 | 64127 | 64127 | N/A | same-call local-only perf probe |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 1736734 | 1736734 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 819 | 819 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 598093 | 598093 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 413893 | 413893 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 187263 | 187263 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 332903 | 332903 | N/A |  |
...
- `crates/canic-core/src/workflow/auth.rs:286:crate::perf!("prepare_call");`
- `crates/canic-core/src/workflow/auth.rs:297:crate::perf!("execute_call");`
- `crates/canic-core/src/workflow/auth.rs:308:crate::perf!("decode_response");`
- `crates/canic-core/src/workflow/auth.rs:319:crate::perf!("finalize_result");`
...
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:164:crate::perf!("cache_root_verifier_proof");`
...
| --- | --- | --- | ---: | ---: | ---: |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `sign_cert` | 1 | 339334 | 339334 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `encode_install_request` | 1 | 298131 | 298131 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 248141 | 248141 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 214555 | 214555 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 140710 | 140710 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 137107 | 137107 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 136735 | 136735 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 110827 | 110827 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 1 | 70012 | 70012 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `evaluate_replay` | 1 | 65508 | 65508 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `hash_cert` | 1 | 64828 | 64828 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `execute_call` | 1 | 62326 | 62326 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 1736734 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `root:canic_response_capability_v1:request-cycles-fresh` | 598093 | Root dispatcher plus replay/capability workflow | [request handler](/home/adam/projects/canic/crates/canic-core/src/workflow/rpc/request/handler/mod.rs), [replay workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/rpc/request/handler/replay.rs) |
| 3 | `root:canic_template_stage_manifest_admin:single-chunk` | 413893 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 1736734 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-5/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 71 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 34 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-06/artifacts/instruction-footprint-5/checkpoint-deltas.json`. |
...
- [instruction-footprint-5.md](./instruction-footprint-5.md)
- [scenario-manifest.json](artifacts/instruction-footprint-5/scenario-manifest.json)
- [perf-rows.json](artifacts/instruction-footprint-5/perf-rows.json)
- [endpoint-matrix.tsv](artifacts/instruction-footprint-5/endpoint-matrix.tsv)
- [checkpoint-deltas.json](artifacts/instruction-footprint-5/checkpoint-deltas.json)
- [flow-checkpoints.log](artifacts/instruction-footprint-5/flow-checkpoints.log)
- [checkpoint-coverage-gaps.json](artifacts/instruction-footprint-5/checkpoint-coverage-gaps.json)
- [verification-readout.md](artifacts/instruction-footprint-5/verification-readout.md)
- [method.json](artifacts/instruction-footprint-5/method.json)
- [environment.json](artifacts/instruction-footprint-5/environment.json)
