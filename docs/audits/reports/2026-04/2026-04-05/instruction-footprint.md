...
- Code snapshot identifier: `3d5edcf9`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T08:03:22Z`
- Branch: `main`
- Worktree: `clean`
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `app` | `canic_time` | `minimal-valid` | 1 | 19826 | 19826 | N/A | same-call local-only perf probe |
| `app` | `canic_env` | `minimal-valid` | 1 | 21495 | 21495 | N/A | same-call local-only perf probe |
| `app` | `canic_log` | `empty-page` | 1 | 358082 | 358082 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 172057 | 172057 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_state` | `minimal-valid` | 1 | 21657 | 21657 | N/A | same-call local-only perf probe |
| `scale_hub` | `plan_create_worker` | `empty-pool` | 1 | 56853 | 56853 | N/A | same-call local-only perf probe |
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2658054 | 2658054 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2868879 | 2868879 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 2274445 | 2274445 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4109 | 4109 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 607069 | 607069 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 587885 | 587885 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 224341 | 224341 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 398127 | 398127 | N/A |  |
...
- `crates/canic-sharding-runtime/src/workflow/mod.rs:158:canic_core::perf!("collect_registry");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:172:canic_core::perf!("plan_assign");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:176:canic_core::perf!("already_assigned");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:192:canic_core::perf!("assign_existing");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:214:canic_core::perf!("allocate_shard");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:217:canic_core::perf!("assign_created");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:229:canic_core::perf!("create_blocked");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:294:canic_core::perf!("bootstrap_empty_active");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:297:canic_core::perf!("assign_bootstrap_created");`

## Measured Checkpoint Deltas

| Scenario | Scope | Label | Count | Total local instructions | Avg local instructions |
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `bootstrap_empty_active` | 1 | 3993465 | 3993465 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3884256 | 3884256 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 503378 | 503378 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_keys` | 1 | 351755 | 351755 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 1 | 295880 | 295880 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 265853 | 265853 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 253330 | 253330 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 252602 | 252602 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 197197 | 197197 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 136960 | 136960 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 114771 | 114771 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 74825 | 74825 |
...
| --- | --- | ---: | --- | --- |
| 1 | `user_hub:create_account:first-account` | 2868879 | Sharding coordinator plus `canic-sharding-runtime` workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-sharding-runtime/src/workflow/mod.rs) |
| 2 | `scale_hub:create_worker:first-worker` | 2658054 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
| 3 | `root:canic_request_delegation:fresh-shard` | 2274445 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `user_hub:create_account:first-account` averages 2868879 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 64 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 38 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint/checkpoint-deltas.json`. |
| `query perf visibility` | PASS | All sampled query scenarios returned same-call local instruction counters through the local-only probe endpoints, so the audit does not rely on non-persisted query-side perf state. |
