...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-05/instruction-footprint-7.md`
- Code snapshot identifier: `1d0c6945`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T19:41:19Z`
- Branch: `main`
- Worktree: `dirty`
...
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 2184751 | 2184751 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 816 | 816 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1475201 | 1475201 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 415933 | 415933 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 185256 | 185256 | N/A |  |
...
- `crates/canic-core/src/workflow/auth.rs:137:crate::perf!("issue_proof");`
- `crates/canic-core/src/workflow/auth.rs:159:crate::perf!("push_signers");`
- `crates/canic-core/src/workflow/auth.rs:172:crate::perf!("push_verifiers");`
- `crates/canic-core/src/workflow/auth.rs:283:crate::perf!("prepare_call");`
- `crates/canic-core/src/workflow/auth.rs:294:crate::perf!("execute_call");`
- `crates/canic-core/src/workflow/auth.rs:305:crate::perf!("decode_response");`
- `crates/canic-core/src/workflow/auth.rs:316:crate::perf!("finalize_result");`
...
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 800163 | 800163 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 262258 | 262258 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 255927 | 255927 |
...
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 245133 | 245133 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 139517 | 139517 |
...
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 113193 | 113193 |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `assign_bootstrap_created` | 1 | 75232 | 75232 |
...
| 3 | `root:canic_request_delegation:fresh-shard` | 2184751 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-8/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 64 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 38 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-8/checkpoint-deltas.json`. |
