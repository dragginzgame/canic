...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-05/instruction-footprint-9.md`
- Code snapshot identifier: `1d0c6945`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T19:56:58Z`
- Branch: `main`
- Worktree: `dirty`
...
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2656831 | 2656831 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2951849 | 2951849 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 1993625 | 1993625 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 816 | 816 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1479110 | 1479110 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 415812 | 415812 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 186552 | 186552 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 332810 | 332810 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `bootstrap_empty_active` | 1 | 4084925 | 4084925 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3893179 | 3893179 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 899835 | 899835 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `sign_cert` | 1 | 337999 | 337999 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `encode_install_request` | 1 | 299029 | 299029 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 272401 | 272401 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 253282 | 253282 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 248112 | 248112 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 137416 | 137416 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 136834 | 136834 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 133209 | 133209 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 113116 | 113116 |
...
| --- | --- | ---: | --- | --- |
| 1 | `user_hub:create_account:first-account` | 2951849 | Sharding coordinator plus `canic-core` sharding workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/sharding/mod.rs) |
| 2 | `scale_hub:create_worker:first-worker` | 2656831 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
| 3 | `root:canic_request_delegation:fresh-shard` | 1993625 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `user_hub:create_account:first-account` averages 2951849 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-10/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 69 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 42 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-10/checkpoint-deltas.json`. |
