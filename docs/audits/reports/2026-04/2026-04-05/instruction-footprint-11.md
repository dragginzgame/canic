...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-05/instruction-footprint-10.md`
- Code snapshot identifier: `1d0c6945`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T20:04:18Z`
- Branch: `main`
- Worktree: `dirty`
...
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2671966 | 2671966 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2944198 | 2944198 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 1773998 | 1773998 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 816 | 816 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1481137 | 1481137 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 410995 | 410995 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 186714 | 186714 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 334323 | 334323 | N/A |  |
...
- `crates/canic-core/src/ops/auth/delegation.rs:28:crate::perf!("ensure_root_key_cached");`
- `crates/canic-core/src/ops/auth/delegation.rs:30:crate::perf!("hash_cert");`
- `crates/canic-core/src/ops/auth/delegation.rs:32:crate::perf!("sign_cert");`
- `crates/canic-core/src/workflow/auth.rs:137:crate::perf!("encode_install_request");`
- `crates/canic-core/src/workflow/auth.rs:138:crate::perf!("issue_proof");`
- `crates/canic-core/src/workflow/auth.rs:160:crate::perf!("push_signers");`
- `crates/canic-core/src/workflow/auth.rs:173:crate::perf!("push_verifiers");`
- `crates/canic-core/src/workflow/auth.rs:236:crate::perf!("encode_install_request");`
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `bootstrap_empty_active` | 1 | 4077093 | 4077093 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3895522 | 3895522 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 902297 | 902297 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `sign_cert` | 1 | 336486 | 336486 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `encode_install_request` | 1 | 297588 | 297588 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 255920 | 255920 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 248406 | 248406 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 139815 | 139815 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 139079 | 139079 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 132935 | 132935 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 111999 | 111999 |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `assign_bootstrap_created` | 1 | 75938 | 75938 |
...
| --- | --- | ---: | --- | --- |
| 1 | `user_hub:create_account:first-account` | 2944198 | Sharding coordinator plus `canic-core` sharding workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/sharding/mod.rs) |
| 2 | `scale_hub:create_worker:first-worker` | 2671966 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
| 3 | `root:canic_request_delegation:fresh-shard` | 1773998 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `user_hub:create_account:first-account` averages 2944198 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-11/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 69 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 42 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-11/checkpoint-deltas.json`. |
