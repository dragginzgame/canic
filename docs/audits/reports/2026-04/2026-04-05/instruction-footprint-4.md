...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-05/instruction-footprint-3.md`
- Code snapshot identifier: `6857f16a`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T19:04:19Z`
- Branch: `main`
- Worktree: `dirty`
...
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2655127 | 2655127 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2957720 | 2957720 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 3237901 | 3237901 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 816 | 816 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1479491 | 1479491 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 413138 | 413138 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 189342 | 189342 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 338003 | 338003 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `bootstrap_empty_active` | 1 | 4085152 | 4085152 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3889278 | 3889278 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 982773 | 982773 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 898207 | 898207 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 772250 | 772250 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_keys` | 1 | 349370 | 349370 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 265774 | 265774 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 255844 | 255844 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 250386 | 250386 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 139490 | 139490 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 138722 | 138722 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 112639 | 112639 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 3237901 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `user_hub:create_account:first-account` | 2957720 | Sharding coordinator plus `canic-core` sharding workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/sharding/mod.rs) |
| 3 | `scale_hub:create_worker:first-worker` | 2655127 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 3237901 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-4/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 64 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 38 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-4/checkpoint-deltas.json`. |
