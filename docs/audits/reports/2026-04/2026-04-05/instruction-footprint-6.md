...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-05/instruction-footprint-5.md`
- Code snapshot identifier: `1d0c6945`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T19:30:27Z`
- Branch: `main`
- Worktree: `dirty`
...
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2669350 | 2669350 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2954170 | 2954170 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 2170277 | 2170277 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 816 | 816 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1480607 | 1480607 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 419625 | 419625 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 189067 | 189067 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 339654 | 339654 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `bootstrap_empty_active` | 1 | 4083606 | 4083606 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3898745 | 3898745 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 900298 | 900298 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 775454 | 775454 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 268965 | 268965 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 252257 | 252257 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 248843 | 248843 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 244230 | 244230 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 139963 | 139963 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 139902 | 139902 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 113482 | 113482 |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `assign_bootstrap_created` | 1 | 74539 | 74539 |
...
| --- | --- | ---: | --- | --- |
| 1 | `user_hub:create_account:first-account` | 2954170 | Sharding coordinator plus `canic-core` sharding workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/sharding/mod.rs) |
| 2 | `scale_hub:create_worker:first-worker` | 2669350 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
| 3 | `root:canic_request_delegation:fresh-shard` | 2170277 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `user_hub:create_account:first-account` averages 2954170 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-6/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 64 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 38 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-6/checkpoint-deltas.json`. |
