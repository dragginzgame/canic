...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-05/instruction-footprint-8.md`
- Code snapshot identifier: `1d0c6945`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T19:48:30Z`
- Branch: `main`
- Worktree: `dirty`
...
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2650126 | 2650126 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2955287 | 2955287 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 2199269 | 2199269 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 816 | 816 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1474971 | 1474971 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 415558 | 415558 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 185252 | 185252 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 340158 | 340158 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_core::workflow::placement::sharding` | `bootstrap_empty_active` | 1 | 4083453 | 4083453 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3885262 | 3885262 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 894631 | 894631 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `sign_cert` | 1 | 307213 | 307213 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `encode_install_request` | 1 | 298144 | 298144 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 268647 | 268647 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 253903 | 253903 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 249337 | 249337 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 245073 | 245073 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::ops::auth::delegation` | `hash_cert` | 1 | 170774 | 170774 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 139517 | 139517 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 137802 | 137802 |
...
| --- | --- | ---: | --- | --- |
| 1 | `user_hub:create_account:first-account` | 2955287 | Sharding coordinator plus `canic-core` sharding workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/sharding/mod.rs) |
| 2 | `scale_hub:create_worker:first-worker` | 2650126 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
| 3 | `root:canic_request_delegation:fresh-shard` | 2199269 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `user_hub:create_account:first-account` averages 2955287 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints because query-side perf rows are not committed; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-9/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 69 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 42 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-05/artifacts/instruction-footprint-9/checkpoint-deltas.json`. |
