...
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-05T22:57:59Z`
- Branch: `main`
- Worktree: `dirty`
- Profile: `release`
...
| --- | --- | --- | ---: | --- | --- |
| `app` | leaf-canister | `table[0]` | 980385 | largest retained symbol from raw-built twiggy analysis | [app.md](artifacts/wasm-footprint-2/app.md) |
| `minimal` | leaf-canister | `table[0]` | 980385 | shared-runtime floor; use this to judge workspace baseline pressure | [minimal.md](artifacts/wasm-footprint-2/minimal.md) |
| `user_hub` | leaf-canister | `table[0]` | 1144096 | largest retained symbol from raw-built twiggy analysis | [user_hub.md](artifacts/wasm-footprint-2/user_hub.md) |
| `user_shard` | leaf-canister | `table[0]` | 1090319 | largest retained symbol from raw-built twiggy analysis | [user_shard.md](artifacts/wasm-footprint-2/user_shard.md) |
| `scale_hub` | leaf-canister | `table[0]` | 1038581 | largest retained symbol from raw-built twiggy analysis | [scale_hub.md](artifacts/wasm-footprint-2/scale_hub.md) |
| `scale` | leaf-canister | `table[0]` | 997147 | largest retained symbol from raw-built twiggy analysis | [scale.md](artifacts/wasm-footprint-2/scale.md) |
| `root` | bundle-canister | `table[0]` | 2491018 | control-plane outlier; embeds only the bootstrap wasm_store artifact and should not be compared directly to leaf peers | [root.md](artifacts/wasm-footprint-2/root.md) |

## Current Size Snapshot

| Canister | Shrunk wasm | Shrink delta | Baseline delta | Note |
| --- | ---: | ---: | --- | --- |
| `app` | 1671990 | 115486 | +3229 | role-specific leaf |
| `minimal` | 1671989 | 115487 | +3226 | shared runtime floor |
| `user_hub` | 1835053 | 126628 | +3889 | role-specific leaf |
| `user_shard` | 1785471 | 124484 | +5886 | role-specific leaf |
| `scale_hub` | 1732446 | 119603 | +2641 | role-specific leaf |
| `scale` | 1689736 | 116573 | +3143 | role-specific leaf |
| `root` | 3723936 | 242094 | +13658 | control-plane bundle outlier |
...
| --- | --- | --- |
| Minimal floor close to feature canisters | WARN | `minimal` shrunk wasm = 1671989, `app` shrunk wasm = 1671990. |
| Root control-plane outlier | WARN | `root` shrunk wasm = 3723936. |
| Shrink delta unexpectedly low | OK | `minimal` shrink delta = 115487 bytes. |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- |
| `app` | leaf-canister | 1787476 | 1671990 | 115486 | 509429 | 473161 | +3229 | 3404 | 3404 | 17 | [app.md](artifacts/wasm-footprint-2/app.md) |
| `minimal` | leaf-canister | 1787476 | 1671989 | 115487 | 509348 | 473162 | +3226 | 3404 | 3404 | 17 | [minimal.md](artifacts/wasm-footprint-2/minimal.md) |
| `user_hub` | leaf-canister | 1961681 | 1835053 | 126628 | 568727 | 522576 | +3889 | 3732 | 3732 | 21 | [user_hub.md](artifacts/wasm-footprint-2/user_hub.md) |
| `user_shard` | leaf-canister | 1909955 | 1785471 | 124484 | 553293 | 512648 | +5886 | 3600 | 3600 | 21 | [user_shard.md](artifacts/wasm-footprint-2/user_shard.md) |
| `scale_hub` | leaf-canister | 1852049 | 1732446 | 119603 | 531724 | 491555 | +2641 | 3518 | 3518 | 20 | [scale_hub.md](artifacts/wasm-footprint-2/scale_hub.md) |
| `scale` | leaf-canister | 1806309 | 1689736 | 116573 | 516133 | 481298 | +3143 | 3444 | 3444 | 18 | [scale.md](artifacts/wasm-footprint-2/scale.md) |
| `root` | bundle-canister | 3966030 | 3723936 | 242094 | 1556798 | 1439197 | +13658 | 5839 | 5839 | 42 | [root.md](artifacts/wasm-footprint-2/root.md) |
