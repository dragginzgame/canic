...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-16.md`
- Code snapshot identifier: `4d32edea`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T14:03:30Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `app` | `canic_time` | `minimal-valid` | 1 | 19853 | 19853 | N/A | same-call local-only perf probe |
| `app` | `canic_env` | `minimal-valid` | 1 | 21456 | 21456 | N/A | same-call local-only perf probe |
| `app` | `canic_log` | `empty-page` | 1 | 358909 | 358909 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 180350 | 180350 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_state` | `minimal-valid` | 1 | 20891 | 20891 | N/A | same-call local-only perf probe |
| `scale_hub` | `plan_create_worker` | `empty-pool` | 1 | 56639 | 56639 | N/A | same-call local-only perf probe |
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2658302 | 2658302 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2954051 | 2954051 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 4356980 | 4356980 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4375 | 4375 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1532060 | 1532060 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 584849 | 584849 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 221129 | 221129 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 391451 | 391451 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `bootstrap_empty_active` | 1 | 3997924 | 3997924 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3884320 | 3884320 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 993079 | 993079 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 897969 | 897969 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 882945 | 882945 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 2 | 645928 | 322964 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 2 | 516476 | 258238 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_keys` | 1 | 421395 | 421395 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 306005 | 306005 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 266577 | 266577 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 195705 | 195705 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `execute_call` | 2 | 137301 | 68650 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 4356980 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `user_hub:create_account:first-account` | 2954051 | Sharding coordinator plus `canic-sharding-runtime` workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-sharding-runtime/src/workflow/mod.rs) |
| 3 | `scale_hub:create_worker:first-worker` | 2658302 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 4356980 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-17/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 63 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 40 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-17/checkpoint-deltas.json`. |
