...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-17.md`
- Code snapshot identifier: `4d32edea`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T14:14:10Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `app` | `canic_time` | `minimal-valid` | 1 | 19849 | 19849 | N/A | same-call local-only perf probe |
| `app` | `canic_env` | `minimal-valid` | 1 | 21452 | 21452 | N/A | same-call local-only perf probe |
| `app` | `canic_log` | `empty-page` | 1 | 358212 | 358212 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 180116 | 180116 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_state` | `minimal-valid` | 1 | 21675 | 21675 | N/A | same-call local-only perf probe |
| `scale_hub` | `plan_create_worker` | `empty-pool` | 1 | 56383 | 56383 | N/A | same-call local-only perf probe |
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2653867 | 2653867 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2957122 | 2957122 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 3934327 | 3934327 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4162 | 4162 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 1526009 | 1526009 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 584924 | 584924 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 229104 | 229104 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 399671 | 399671 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `bootstrap_empty_active` | 1 | 3999761 | 3999761 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3886924 | 3886924 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 985457 | 985457 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 902602 | 902602 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 2 | 645625 | 322812 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 2 | 513391 | 256695 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 504032 | 504032 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_keys` | 1 | 415675 | 415675 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 292715 | 292715 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 264185 | 264185 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 197836 | 197836 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 139418 | 139418 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 3934327 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `user_hub:create_account:first-account` | 2957122 | Sharding coordinator plus `canic-sharding-runtime` workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-sharding-runtime/src/workflow/mod.rs) |
| 3 | `scale_hub:create_worker:first-worker` | 2653867 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 3934327 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-18/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 63 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 40 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-18/checkpoint-deltas.json`. |
