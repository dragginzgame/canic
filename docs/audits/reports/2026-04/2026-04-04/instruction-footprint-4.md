...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-3.md`
- Code snapshot identifier: `4d32edea`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T12:11:27Z`
- Branch: `main`
- Worktree: `dirty`
- Execution environment: `PocketIC`
- Target canisters in scope: `app` `root` `scale_hub` `test` `user_hub`
- Target endpoints/flows in scope: `canic_env` `canic_log` `canic_response_capability_v1` `canic_subnet_registry` `canic_subnet_state` `canic_template_prepare_admin` `canic_template_publish_chunk_admin` `canic_template_stage_manifest_admin` `canic_time` `create_account` `create_worker` `plan_create_worker` `test`
...
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 114852 | 114852 |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `assign_existing` | 1 | 87219 | 87219 |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `collect_registry` | 1 | 55353 | 55353 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler::replay` | `evaluate_replay` | 1 | 35781 | 35781 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler::replay` | `reserve_fresh` | 1 | 34331 | 34331 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `register_worker` | 1 | 24303 | 24303 |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `plan_assign` | 1 | 14917 | 14917 |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-4/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 51 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 18 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-4/checkpoint-deltas.json`. |
