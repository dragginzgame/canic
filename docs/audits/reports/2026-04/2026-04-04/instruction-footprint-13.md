...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-12.md`
- Code snapshot identifier: `4d32edea`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T13:29:00Z`
- Branch: `main`
- Worktree: `dirty`
...
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 181307 | 181307 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_state` | `minimal-valid` | 1 | 20969 | 20969 | N/A | same-call local-only perf probe |
...
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 5502075 | 5502075 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4191 | 4191 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 2267203 | 2267203 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 585878 | 585878 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 221779 | 221779 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 390788 | 390788 | N/A |  |
...
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:301:canic_core::perf!("chunk_store_insert");`
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:311:canic_core::perf!("chunk_store_accounting");`
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:325:canic_core::perf!("chunk_store_insert");`
- `crates/canic-control-plane/src/storage/stable/template/chunked.rs:332:canic_core::perf!("chunk_store_accounting");`
...
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 1151853 | 1151853 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 1022862 | 1022862 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 910327 | 910327 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 778596 | 778596 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 721651 | 721651 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 672314 | 672314 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 2 | 643767 | 321883 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 2 | 521640 | 260820 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `evaluate_replay` | 1 | 379053 | 379053 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 253942 | 253942 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_request_delegation:fresh-shard` | 5502075 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| --- | --- | --- |
| Flow checkpoint coverage present | INFO | Current repo scan found 61 `perf!` call sites under `crates/`. |
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_request_delegation:fresh-shard` averages 5502075 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-13/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 61 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 38 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-13/checkpoint-deltas.json`. |
