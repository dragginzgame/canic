...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-28.md`
- Code snapshot identifier: `1d5a53ae`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T16:37:44Z`
- Branch: `main`
- Worktree: `dirty`
...
| --- | --- | --- |
| Scenario manifest recorded | PASS | `artifacts/instruction-footprint-29/scenario-manifest.json` captures the scenario identity tuple for every sampled endpoint. |
| Normalized perf rows recorded | PASS | `artifacts/instruction-footprint-29/perf-rows.json` stores canonical endpoint rows with count and total local instructions. |
| Checkpoint deltas recorded | PASS | `artifacts/instruction-footprint-29/checkpoint-deltas.json` stores non-zero per-scenario checkpoint rows. |
...
| Flow checkpoint coverage scanned | PASS | `artifacts/instruction-footprint-29/flow-checkpoints.log` records the current repo scan result. |
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| `app` | `canic_time` | `minimal-valid` | 1 | 19916 | 19916 | N/A | same-call local-only perf probe |
| `app` | `canic_env` | `minimal-valid` | 1 | 21585 | 21585 | N/A | same-call local-only perf probe |
| `app` | `canic_log` | `empty-page` | 1 | 359006 | 359006 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 173870 | 173870 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_state` | `minimal-valid` | 1 | 21694 | 21694 | N/A | same-call local-only perf probe |
| `scale_hub` | `plan_create_worker` | `empty-pool` | 1 | 56353 | 56353 | N/A | same-call local-only perf probe |
| `scale_hub` | `create_worker` | `empty-pool` | 1 | 2660387 | 2660387 | N/A |  |
| `user_hub` | `create_account` | `new-principal` | 1 | 2869604 | 2869604 | N/A |  |
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 2281850 | 2281850 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4142 | 4142 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 612625 | 612625 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 587276 | 587276 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 223380 | 223380 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 396500 | 396500 | N/A |  |
...
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:145:crate::perf!("cache_root_verifier_keys");`
- `crates/canic-core/src/workflow/rpc/request/handler/execute.rs:151:crate::perf!("cache_root_verifier_proof");`
...
- `crates/canic-core/src/workflow/rpc/request/handler/replay.rs:163:crate::perf!("commit_encode");`
- `crates/canic-core/src/workflow/rpc/request/handler/replay.rs:172:crate::perf!("abort_replay");`
...
- `crates/canic-sharding-runtime/src/workflow/mod.rs:133:canic_core::perf!("bootstrap_empty_active");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:136:canic_core::perf!("assign_bootstrap_created");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:170:canic_core::perf!("collect_registry");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:184:canic_core::perf!("plan_assign");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:188:canic_core::perf!("already_assigned");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:204:canic_core::perf!("assign_existing");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:226:canic_core::perf!("allocate_shard");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:229:canic_core::perf!("assign_created");`
- `crates/canic-sharding-runtime/src/workflow/mod.rs:241:canic_core::perf!("create_blocked");`

## Measured Checkpoint Deltas

| Scenario | Scope | Label | Count | Total local instructions | Avg local instructions |
| --- | --- | --- | ---: | ---: | ---: |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `bootstrap_empty_active` | 1 | 3995101 | 3995101 |
| `scale_hub:create_worker:first-worker` | `canic_core::workflow::placement::scaling` | `create_canister` | 1 | 3887286 | 3887286 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 504253 | 504253 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_keys` | 1 | 354872 | 354872 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 1 | 299578 | 299578 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::execute` | `cache_root_verifier_proof` | 1 | 263121 | 263121 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 256322 | 256322 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 1 | 254877 | 254877 |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::storage::stable::template::chunked` | `chunk_store_insert` | 1 | 196572 | 196572 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 138774 | 138774 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `preflight` | 1 | 116649 | 116649 |
| `user_hub:create_account:first-account` | `canic_sharding_runtime::workflow` | `assign_bootstrap_created` | 1 | 75104 | 75104 |
...
| --- | --- | ---: | --- | --- |
| 1 | `user_hub:create_account:first-account` | 2869604 | Sharding coordinator plus `canic-sharding-runtime` workflow | [user_hub/lib](/home/adam/projects/canic/canisters/user_hub/src/lib.rs), [sharding workflow](/home/adam/projects/canic/crates/canic-sharding-runtime/src/workflow/mod.rs) |
| 2 | `scale_hub:create_worker:first-worker` | 2660387 | Scaling coordinator plus `canic-core` placement workflow | [scale_hub/lib](/home/adam/projects/canic/canisters/scale_hub/src/lib.rs), [scaling workflow](/home/adam/projects/canic/crates/canic-core/src/workflow/placement/scaling/mod.rs) |
| 3 | `root:canic_request_delegation:fresh-shard` | 2281850 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `user_hub:create_account:first-account` averages 2869604 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-29/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 64 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 38 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-29/checkpoint-deltas.json`. |
...
- [instruction-footprint-29.md](./instruction-footprint-29.md)
- [scenario-manifest.json](artifacts/instruction-footprint-29/scenario-manifest.json)
- [perf-rows.json](artifacts/instruction-footprint-29/perf-rows.json)
- [endpoint-matrix.tsv](artifacts/instruction-footprint-29/endpoint-matrix.tsv)
- [checkpoint-deltas.json](artifacts/instruction-footprint-29/checkpoint-deltas.json)
- [flow-checkpoints.log](artifacts/instruction-footprint-29/flow-checkpoints.log)
- [checkpoint-coverage-gaps.json](artifacts/instruction-footprint-29/checkpoint-coverage-gaps.json)
- [verification-readout.md](artifacts/instruction-footprint-29/verification-readout.md)
- [method.json](artifacts/instruction-footprint-29/method.json)
- [environment.json](artifacts/instruction-footprint-29/environment.json)
