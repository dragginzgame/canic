...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-10.md`
- Code snapshot identifier: `4d32edea`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T13:08:48Z`
- Branch: `main`
- Worktree: `dirty`
...
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 180802 | 180802 | N/A | same-call local-only perf probe |
...
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 5488293 | 5488293 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4191 | 4191 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 2268324 | 2268324 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 587125 | 587125 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 222254 | 222254 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 9699886 | 9699886 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::ops::storage::template::chunked` | `publish_stage_upsert_chunk` | 1 | 9518670 | 9518670 |
...
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 723741 | 723741 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 673212 | 673212 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_template_publish_chunk_admin:single-chunk` | 9699886 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `root:canic_request_delegation:fresh-shard` | 5488293 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_template_publish_chunk_admin:single-chunk` averages 9699886 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-11/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 57 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 36 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-11/checkpoint-deltas.json`. |
