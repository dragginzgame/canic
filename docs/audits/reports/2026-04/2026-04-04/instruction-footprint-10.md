...
- Compared baseline report path: `docs/audits/reports/2026-04/2026-04-04/instruction-footprint-9.md`
- Code snapshot identifier: `4d32edea`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-04T13:03:49Z`
- Branch: `main`
- Worktree: `dirty`
...
| `root` | `canic_subnet_registry` | `representative-valid` | 1 | 180569 | 180569 | N/A | same-call local-only perf probe |
| `root` | `canic_subnet_state` | `minimal-valid` | 1 | 20890 | 20890 | N/A | same-call local-only perf probe |
...
| `root` | `canic_request_delegation` | `fresh-shard` | 1 | 5489293 | 5489293 | N/A |  |
| `test` | `test_verify_delegated_token` | `valid-delegated-token` | 1 | 4191 | 4191 | N/A |  |
| `test` | `test` | `minimal-valid` | 1 | 421 | 421 | N/A |  |
| `root` | `canic_response_capability_v1` | `cycles-request` | 1 | 2266270 | 2266270 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 587129 | 587129 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 222256 | 222256 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 18237898 | 18237898 | N/A |  |
...
| --- | --- | --- | ---: | ---: | ---: |
| `root:canic_template_publish_chunk_admin:single-chunk` | `canic_control_plane::ops::storage::template::chunked` | `publish_stage_upsert_chunk` | 1 | 18056666 | 18056666 |
...
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 1151382 | 1151382 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler` | `commit_replay` | 1 | 1078124 | 1078124 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `issue_proof` | 1 | 897178 | 897178 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 780775 | 780775 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler` | `execute_capability` | 1 | 722741 | 722741 |
| `root:canic_response_capability_v1:request-cycles-fresh` | `canic_core::workflow::rpc::request::handler::replay` | `prepare_replay_input` | 1 | 673158 | 673158 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `prepare_call` | 2 | 642521 | 321260 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::auth` | `decode_response` | 2 | 522823 | 261411 |
| `root:canic_request_delegation:fresh-shard` | `canic_core::workflow::rpc::request::handler::replay` | `evaluate_replay` | 1 | 378967 | 378967 |
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_template_publish_chunk_admin:single-chunk` | 18237898 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `root:canic_request_delegation:fresh-shard` | 5489293 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_template_publish_chunk_admin:single-chunk` averages 18237898 local instructions in this first baseline. |
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Update scenarios were sampled before/after through persisted perf rows, and query scenarios used same-call local-only probe endpoints; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-10/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 57 checkpoint call sites. |
| `checkpoint delta capture` | PASS | 36 non-zero checkpoint delta rows were captured under `/home/adam/projects/canic/docs/audits/reports/2026-04/2026-04-04/artifacts/instruction-footprint-10/checkpoint-deltas.json`. |
