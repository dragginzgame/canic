# Instruction Footprint Audit - 2026-04-03
...
- Code snapshot identifier: `928f6003`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-04-03T07:34:58Z`
- Branch: `main`
- Worktree: `dirty`
...
| `test` | `test` | `minimal-valid` | 1 | 330 | 330 | N/A |  |
| `root` | `canic_template_stage_manifest_admin` | `single-chunk` | 1 | 575406 | 575406 | N/A |  |
| `root` | `canic_template_prepare_admin` | `single-chunk` | 1 | 217731 | 217731 | N/A |  |
| `root` | `canic_template_publish_chunk_admin` | `single-chunk` | 1 | 18767190 | 18767190 | N/A |  |
...
- `crates/canic-control-plane/src/workflow/bootstrap/root.rs:610:canic_core::perf!("bootstrap_prune_store_catalog");`
- `crates/canic-control-plane/src/workflow/bootstrap/root.rs:632:canic_core::perf!("bootstrap_create_wasm_store");`
- `crates/canic-control-plane/src/workflow/bootstrap/root.rs:634:canic_core::perf!("bootstrap_sync_store_inventory");`
- `crates/canic-control-plane/src/workflow/bootstrap/root.rs:641:canic_core::perf!("bootstrap_import_store_catalog");`
- `crates/canic-control-plane/src/workflow/runtime/template/publication.rs:1329:canic_core::perf!("publish_prepare_store");`
- `crates/canic-control-plane/src/workflow/runtime/template/publication.rs:1354:canic_core::perf!("publish_push_store_chunk");`
- `crates/canic-control-plane/src/workflow/runtime/template/publication.rs:1387:canic_core::perf!("publish_promote_manifest");`
...
| --- | --- | ---: | --- | --- |
| 1 | `root:canic_template_publish_chunk_admin:single-chunk` | 18767190 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 2 | `root:canic_template_stage_manifest_admin:single-chunk` | 575406 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
| 3 | `root:canic_template_prepare_admin:single-chunk` | 217731 | Shared runtime surface | [endpoints](/home/adam/projects/canic/crates/canic/src/macros/endpoints.rs) |
...
| --- | --- | --- |
| Flow checkpoint coverage present | INFO | Current repo scan found 52 `perf!` call sites under `crates/`. |
...
| Highest sampled endpoint currently highest-cost | WARN | `root:canic_template_publish_chunk_admin:single-chunk` averages 18767190 local instructions in this first baseline. |
