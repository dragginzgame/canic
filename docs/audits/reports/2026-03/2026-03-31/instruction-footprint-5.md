...
- Compared baseline report path: `docs/audits/reports/2026-03/2026-03-31/instruction-footprint-4.md`
- Code snapshot identifier: `4346bc25`
- Method tag/version: `Method V1`
- Comparability status: `partial`
- Auditor: `codex`
- Run timestamp (UTC): `2026-03-31T12:06:44Z`
- Branch: `main`
- Worktree: `dirty`
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Perf rows were sampled before and after each scenario; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-03/2026-03-31/artifacts/instruction-footprint-5/perf-rows.json`. |
