...
- Auditor: `codex`
- Run timestamp (UTC): `2026-03-31T07:54:53Z`
- Branch: `main`
- Worktree: `dirty`
...
- `crates/canic/tests/instruction_audit.rs:611:if line.contains("perf!(") {`
...
| `canic_metrics(MetricsKind::Perf, PageRequest { limit=512, offset=0 })` | PASS | Perf rows were sampled before and after each scenario; normalized rows saved under `/home/adam/projects/canic/docs/audits/reports/2026-03/2026-03-31/artifacts/instruction-footprint/perf-rows.json`. |
| `repo checkpoint scan` | PASS | Found 1 checkpoint call sites. |
