...
* Features require edits across `endpoints -> workflow -> policy -> ops -> model`
...
* lifecycle phase (`init` / `post_upgrade` / runtime timer)
* role/subnet context
...
* root capability/replay-related workflow enums
