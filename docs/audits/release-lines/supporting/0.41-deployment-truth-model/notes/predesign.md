...
the
[`0.41` design](../../../../../design/archive/0.41-deployment-truth-model/0.41-design.md),
the later per-line design docs, and
`../0.41-0.46-deployment-roadmap.md`.
...
docs/audits/release-lines/supporting/0.41-deployment-truth-model/0.41-0.46-deployment-roadmap.md
