...
| CANIC-098-POST-IC-HELPERS-001 generic IC helper ownership | P2 | corrected in v0.98.21 | Canonical instrumented Call builder restored; CDK/HTTP/build-network facades remain removed |
...
account shape and makes persisted CMC identity authoritative on resume.
Released `v0.98.21` removes the unsupported ICRC-103 configuration and
