...
- State: accepted and scheduled as reserve-Fleet critical-path step 2. No
...
- Successors: 0.105 platform B1 may continue as evidence-only work but must
  reconcile its final timer inventory against 0.104. No 0.106 root-funding or
  0.107 estate mutation begins before 0.104 closeout.
...
2. 0.104 completes the `ic-timers` consumer and async-job recovery hard cut.
