# Canic 0.112 Design: Language-Neutral Managed-Guest Feasibility
...
- Sequence: this bounded design is extracted from the broader
  [0.112 exploration](../../audits/working/0.112-motokoisation/exploration.md).
...
- [0.112 end-state exploration](../../audits/working/0.112-motokoisation/exploration.md)
