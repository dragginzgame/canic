# Canic 0.108 Design: Declarative Authentication Profiles
...
- Sequence: this is the 0.108 design line. It follows the
  ...
  the
  [0.106 direct transport groundwork](../0.106-cross-subnet-data-transport-groundwork/0.106-design.md)
  and the proposed
  [0.107 Coordinator Worker concept](../0.107-coordinator-workers/0.107-design.md).
