# Idea Status: Framework-Neutral Local Application Authorization

Classification: deferred and unnumbered. The former `0.103` working number is
retired; retained batch notes are historical review context and authorize no
current evidence or implementation work.

Former status: peer-review lifetime, client-access, predecessor,
lifecycle-composition and revocation feedback incorporated; B1 evidence work
was approved before deferral; B2 implementation was held

Design:
[Framework-neutral local application authorization](design.md)

Status cut: 2026-08-14

## Former Reviewed Boundary
