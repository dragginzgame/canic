...
- Classification: deferred, unnumbered idea. Its former working number was
  `0.112`; Motoko guest feasibility is not scheduled Fleet work.
- Former review status: proposed for maintainer approval as an M0 feasibility
  slice only.
...
- Sequence: this bounded design is extracted from the broader
  [managed-guest exploration](exploration.md).
  The exploration remains an end-state
...
- [Managed-guest end-state exploration](exploration.md)
