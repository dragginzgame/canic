# Canic 0.109 Design: Standalone Blob Service Extraction
...
- optional Canic backup archival, mandatory client-side encryption,
  ...
  [0.111 encrypted canister-snapshot archive design](../0.111-optional-encrypted-canister-snapshot-archives/0.111-design.md);
