...
- State: accepted and scheduled as the production-safety gate after 0.108.
...
- Implementation approval: none. B1 requires completed 0.108, an immutable
...
Design: [Stateful Fleet release adoption](0.109-design.md)

## Release-Batch Tracker

| Batch | Outcome | Included evidence and fallout | Focused validation | Status |
| --- | --- | --- | --- | --- |
| B1 | Exact predecessor and transition contract | Released schemas/artifacts, role order, operation fences, backup/dry-run contract and ceilings | Reproducible inventory and explicit acceptance | Blocked on 0.108, released predecessor and promotion |
...
| B5 | Stateful application composition | Principal/data preservation, 0.104 participant, 0.105 auth policy and 0.108 retirement evidence | Stateful Canic+IcyDB PocketIC journey | Blocked on B4 |
...
No 0.109 work is authorized by this scheduling cut. Finish 0.108, select the
