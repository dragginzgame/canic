...
1,126-identity qualified subset. The direct-constructor audit may add further
exact or safe projection identities; this table is not yet the whole-program
total.
