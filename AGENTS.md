...
│  └─ test-configs/         # Demo/test config fixtures
├─ sandbox/
│  └─ minimal/              # Manual local sandbox canister
├─ test/                    # Internal correctness/PocketIC canister fixtures
└─ audit/                   # Internal audit/perf probe canisters
