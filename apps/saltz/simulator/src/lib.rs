...
pub use executable::{
    ...
    KERNEL_GAIN_SECONDS, KERNEL_SUPPORT_SECONDS, MAX_BURN_RATE_CYCLES_PER_SECOND,
    MAX_TOTAL_BURN_CYCLES, MIN_RETAINED_CYCLES, OBSERVATION_PHASE_LEAD_SECONDS,
    PRE_ROLL_STEP_COUNT, TARGET_AMPLITUDE_CYCLES_PER_SECOND, TARGET_FLOOR_CYCLES_PER_SECOND,
    WAVEFORM_STEP_COUNT, compile_executable_plan,
};
