...
use canic::{Error, cdk::types::Principal, ids::CanisterRole, prelude::*};

const POOL_NAME: &str = "user_shards";
const USER_HUB: CanisterRole = CanisterRole::new("user_hub");
...
/// Run no-op setup for the user hub shell.
async fn canic_setup() {}

/// Accept no install payload for the user hub shell.
async fn canic_install(_: Option<Vec<u8>>) {}

/// Run no-op upgrade handling for the user hub shell.
