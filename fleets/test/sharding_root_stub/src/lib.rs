...
const STUB_ATTESTATION_KEY_NAME: &str = "test_key_1";
const EMPTY_PUBLIC_KEY_HASH: [u8; 32] = [
...
async fn canic_attestation_key_set() -> Result<AttestationKeySet, Error> {
    ...
    Ok(AttestationKeySet {
        ...
        keys: vec![AttestationKey {
            key_id: STUB_ATTESTATION_KEY_ID,
            key_hash: EMPTY_PUBLIC_KEY_HASH,
            key_name: STUB_ATTESTATION_KEY_NAME.to_string(),
            public_key: Vec::new(),
